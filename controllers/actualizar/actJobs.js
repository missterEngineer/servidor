...
const actJobs = {
    ...
    actualizar: async (req, res) =>{
        ...
        try {
            ...
            await pool.query(queryUpdate, [empresa, puestoTrabajo, experiencia, actividades , stateFinJoin == "true" ? true : false, dateInic, stateFinJoin == "false" ? dateFin : null, id]);
